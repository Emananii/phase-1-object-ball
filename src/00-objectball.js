...
console.log("Object.keys(oo) =>", Object.keys(oo));//returns an array of all keys
console.log("Object.values(oo) =>", Object.values(oo));//returns an array of all values
console.log("Object.entries(oo) =>", Object.entries(oo));//returns an array of arrays containing [key, value] together.
